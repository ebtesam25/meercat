    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{marginHorizontal:'7.5%', marginTop:'10%'}}>
                ...
                <Text style={{fontFamily:'H', fontSize:35, color:"#FFF", lineHeight:35}}>{!calibrated ? "Calibrating Hardware...":"Hardware Calibrated"}</Text>
                {!calibrated &&<Text style={{fontFamily:'H', fontSize:20, color:"#FFF", marginTop:'5%'}}>Please wait, this may take a while...</Text>}
                ...
                {!calibrated &&<TouchableOpacity onPress={()=>navigation.navigate('Homr')}><Text style={{color:"#FCDBDC", fontFamily:"E", fontSize:20, marginLeft:'1%',
                 marginTop:'5%', backgroundColor:`rgba(252, 219, 220, 0.3)`, width:'20%', lineHeight:18}}>or skip</Text></TouchableOpacity>}
