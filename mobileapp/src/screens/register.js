    ...
    return (
        <View style={styles.container}>
            <View style={{marginHorizontal:'7.5%', marginTop:'10%'}}>
                ...
                <Text style={{fontFamily:'E', fontSize:25, color:"#FFF", lineHeight:25}}>Create an account</Text>
                <View style={{marginTop:'15%', justifyContent:'space-evenly'}}></View>
               <View style={{backgroundColor:`rgba(252, 219, 220, 0.5)`, borderRadius:0, paddingHorizontal:'5%', paddingVertical:'1.5%', flexDirection:'row'}}>
                   <View style={{width:'90%'}}>
               ...
               <TouchableOpacity onPress={()=>navigation.navigate('Metrics')}>
                ...
                <TouchableOpacity  onPress={()=>navigation.navigate('Login')}><Text style={{color:"#1D4E89", fontFamily:"E", fontSize:20, marginLeft:'10%',
                 marginTop:'5%', backgroundColor:`rgba(252, 219, 220, 0.3)`, width:'25%', lineHeight:18}}>or login</Text></TouchableOpacity>
